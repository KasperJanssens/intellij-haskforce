...
//        Collection<HaskellNamedElement> namedElements = StubIndex.getElements(HaskellAllNameIndex.KEY, name, project, scope, HaskellNamedElement.class);
    ...
    private @NotNull List<PsiElementResolveResult> handleImportReferences(@NotNull HaskellImpdecl haskellImpdecl,
        ...
        //This snippet will make sure that the module name of the import statement will point to
        // the module name it's imported. For 'folders' in the import statement we want to go
        // for another approach. This code does too much still (it stems from the time when 'folder's
        // got referenced to the 'folder' part in the module declaration. But this makes renaming folders
        // hard, and frankly, I don't think it's correct anyway.
